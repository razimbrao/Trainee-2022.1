...
<body>
        ...
        <div class="valores">
            ...
            <div class="descricao-esq">
                <ul>
                    <li>
                        <span>Amantes dos esportes</span>:<br>Somos uma empresa formada por pessoas que gostam do que fazem.
                    </li>
                    <li>
                        <span>Responsabilidade</span>:<br>"Eu digo, eu faço". Isso define o nosso conceito de autonomia.
                    </li>
                    <li>
                        <span>Qualidade</span>:<br>Trabalhamos com produtos de qualidade comprovada, afinal, estamos aqui para te fazer bem.
                    </li>
                    <li>
